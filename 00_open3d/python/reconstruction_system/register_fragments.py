...
from visualization_reg import draw_registration_result
sys.path.append(".")
from optimize_posegraph import optimize_posegraph_for_scene,optimize_posegraph_for_fragment
...
if __name__ == "__main__":
    json_file='C:/00_work/05_src/zed2/00_open3d/python/reconstruction_system/config/redwood_objects/car.json'
