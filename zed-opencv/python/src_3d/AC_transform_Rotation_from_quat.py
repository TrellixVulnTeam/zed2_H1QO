...
def main_r_from_quat_005():
    ...
    #平行移動
    tx,ty,tz=(-2.987055406-2.541653005),0,0
    t0=[
        [1,0,0,tx],
        [0,1,0,ty],
        [0,0,1,tz],
    ...
    pcd0t=pcd0t.transform(t0)
    ft_pcd_m='C:/00_work/05_src/data/fromWATA/q_005_cam0_pcd_trans.ply'
    open3d.io.write_point_cloud(ft_pcd_m, pcd0t)
    ft_pcd_m='C:/00_work/05_src/data/fromWATA/q_005_cam1_pcd_trans.ply'
    open3d.io.write_point_cloud(ft_pcd_m, pcd1t)
def main_r_from_quat_006():
    src_vec0 = np.array([2.987055406 , -5.17373172864616 ,   -2.00])
    src_vec1 = np.array([-2.541653005 ,4.402272140611028 ,   -1.50])
    tgt_vec0 =  np.array([ 0,5.17373172864616, 0.])
    tgt_vec1 =  np.array([0,-4.402272140611028, 0.])
    ...
    #平行移動
    tx,ty,tz=(-5.17373172864616-4.402272140611028),0,0
    t0=[
        [1,0,0,tx],
        [0,1,0,ty],
        [0,0,1,tz],
    ...
    pcd0t=pcd0t.transform(t0)
    ft_pcd_m='C:/00_work/05_src/data/fromWATA/q_006_cam0_pcd_trans.ply'
    open3d.io.write_point_cloud(ft_pcd_m, pcd0t)
    ft_pcd_m='C:/00_work/05_src/data/fromWATA/q_006_cam1_pcd_trans.ply'
    open3d.io.write_point_cloud(ft_pcd_m, pcd1t)

def main_r_from_quat_007():
    src_vec0 = np.array([2.987055406 , -5.17373172864616 ,   -2.00])
    src_vec1 = np.array([-2.541653005 ,4.402272140611028 ,   -1.50])
    tgt_vec0 =  np.array([ 0,5.17373172864616, 0.])
    tgt_vec1 =  np.array([0,-4.402272140611028, 0.])
    ...
    def q_2_m(src_vec, tgt_vec):
        ...
        m=r.as_matrix()
        return m
    R0=q_2_m(unit_ch_vector(tgt_vec0),unit_ch_vector(src_vec0))
    R1=q_2_m(unit_ch_vector(tgt_vec1),unit_ch_vector(src_vec1))
    ...
    pcd0t=pcd0t.transform(t0)
    ft_pcd_m='C:/00_work/05_src/data/fromWATA/q_007_cam0_pcd_trans.ply'
    open3d.io.write_point_cloud(ft_pcd_m, pcd0t)
    ft_pcd_m='C:/00_work/05_src/data/fromWATA/q_007_cam1_pcd_trans.ply'
    open3d.io.write_point_cloud(ft_pcd_m, pcd1t)

def main_r_from_quat_00t():
    vectors=[
        
    ]
    src_vec0 = np.array([2.987055406, -5.17373172864616, 0])
    tgt_vec0 = np.array([2.987055406, 0, 0.])
    ...
    ft_pcd_m='C:/00_work/05_src/data/fromWATA/qn_00t_cam0_pcd_trans_01.ply'
    open3d.io.write_point_cloud(ft_pcd_m, pcd0t)
if __name__ == '__main__':
    main_r_from_quat_00t()