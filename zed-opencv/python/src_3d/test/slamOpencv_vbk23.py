...
#     R1 = eulerAnglesToRotationMatrix(e1)
    ...
    # print("\nOutput Euler angles :\n{0}".format(e1))
    # print("\nR1 :\n{0}".format(R1))
# kp1,kp2,goodMatches=computeKeyPointsAndMaches_orb(rgb1,rgb2)
# kp1,kp2,goodMatches=computeKeyPointsAndMaches_sift(rgb1,rgb2)
...
open3d.io.write_point_cloud('pcd_trans_1t.ply', cloud1t)
open3d.io.write_point_cloud('pcd_trans_2t.ply', cloud2t)
pcd=merge_points_cloud([cloud1t,cloud2])
open3d.io.write_point_cloud('pcd_merge_t.ply', pcd)