...
def main_func(keymatchfun,ext,cam):
    ...
    estPose=keypoint_tm(pts_obj1,pts_obj2)
    ...
    points1t_1 = warp3d(points1.T, pose_mat)
    points1t_2 = warp3d(points1.T, estPose)

    cloud1t = make_pcd(points1t_1.T, colors1)
    cloud1t2 = make_pcd(points1t_2.T, colors1)
    # cloud1t=cloud1.transform(pose_mat)
    # cloud1t2=cloud1t.transform(estPose)
