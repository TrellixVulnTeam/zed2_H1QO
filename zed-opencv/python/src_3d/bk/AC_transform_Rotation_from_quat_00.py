...
def main_r_from_quat1105_001():
    ...
    ft_pcd_m='C:/00_work/05_src/data/fromWATA/q_y_cam0_pcd_trans.ply'
    open3d.io.write_point_cloud(ft_pcd_m, pcd0t)
    ft_pcd_m='C:/00_work/05_src/data/fromWATA/q_y_cam1_pcd_trans.ply'
