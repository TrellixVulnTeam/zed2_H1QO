...
def main():
    ...
    # nest = scene_obj.make_NormalEstimationOMP()
    nest= grid_sce.make_NormalEstimation()
    ...
    object.setRadiusSearch(0.025)
    object_features = object.compute()

    # fest_sce = scene.make_FeatureEstimation()
    scene.setRadiusSearch(0.025)
    scene_features = scene.compute()
