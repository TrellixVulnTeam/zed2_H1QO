...
import open3d
import copy as cp
from object_detection_draw_v7 import load_model_obj,human_bbox_on_image_inferenced_result,get_img_bboxes
...
class moving_object_merge:
    ...
    def get_mask_by_segmentation_object_detection(self,fnpath):
        ...
        for imgbbox, bbox in zip(img_objs, bboxes_ret):
            ...
            w, h = img_org.shape[:2]
            seg_map_mask = np.where(seg_map == 13, 255, 0)
